...
<div class="navbar">
    <div>
        <a href="chooser"><img src="/img/yoco/demo/yoco_logo.svg" style="height: 50px;"/></a>
...
<script>
    ...
    var public_key = '<?php echo($config["public_key"]); ?>';
</script>

<?php
include $_SERVER['DOCUMENT_ROOT'] . '/lib/demo-tools.php';
?>
